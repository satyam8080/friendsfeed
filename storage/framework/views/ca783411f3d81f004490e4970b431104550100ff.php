            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav d-none d-md-block">
                    <li class="nav-item" id="5">
                        <a  onclick="window.location.href ='<?php echo e(URL('profile')); ?> ';" class="nav-link" style="cursor:pointer;" > <img src="https://vignette.wikia.nocookie.net/the-sun-vanished/images/5/5d/Twitter-avi-gender-balanced-figure.png/revision/latest?cb=20180713020754" alt="" class="img-fluid rounded-circle" style="height: 32px; width: 32px; ">
                            <b style="display:inline; position:absolute; margin-left:.5rem;">  <?php echo e($userName); ?> </b>
                        </a>
                    </li>
                </ul>
              <!--for log out-->
