...
<div class="card" style="width: 37rem;  margin:auto; margin-top : 2rem;">
    ...
    <button style="background:none;border:none;" id="dot_btn-<?php echo e(Auth::user()->id); ?>" onclick="changedot(this.id); return false;"><!--generate id at runn time-->
...
</div><?php /**PATH D:\Projects\xampp\htdocs\friendsfeed\resources\views/templates/card.blade.php ENDPATH**/ ?>